...
async function startconn() {
            ...
            try {
                ...
                if (mek.key && mek.key.remoteJid) {
                    await conn.sendMessage(mek.key.remoteJid, { 
                        text: 'GAAJU MD: Oops! An error occurred while processing your message.',
                        contextInfo: {
                            forwardingScore: 1,
                            isForwarded: false,
    ...
    if (pairingCode && !conn.authState.creds.registered) {
        ...
        if (!pn('+' + phoneNumber).isValid()) {
            console.log(chalk.red('Invalid phone number. Please enter your full international number (e.g., 234801234567 for AFG, 627687687779 for Indonesia, etc.'));
            process.exit(1);
        }
    ...
    console.log(chalk.cyan(`║        🤖 GAAJU MD V2 PAIRING MODE       ║`))
    console.log(chalk.cyan(`╚════════════════════════════════════╝`))
...
│     *World Best BOT GAAJU-MD_V2* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing GAAJU-MD!* 

╭──〔 🔗 *Information* 〕  
├─ 🧩 *Prefix:* = .
├─ 📢 *Join Channel:*  
│    https://whatsapp.com/channel/0029VbBvGgyFsn0alyIDjw0z?mode=ac_t  
├─ 🌟 *GitHub:*  
│    https://github.com/Xchristech2/GAAJU-MD_V2  
╰─🚀 *Powered by Xchristech*        
`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: false,
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n    ${chalk.bold.blue(`[ ${global.botname || 'GAAJU MD V2'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: GAAJUHACKS OFFICIAL`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: Xchristech2`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: GAAJU HACKS TEAM`))
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 GAAJU MD V2 Connected Successfully! ✅`))
            console.log(chalk.cyan(`< ================================================== >`))
        }
        if (
            connection === "close" &&
