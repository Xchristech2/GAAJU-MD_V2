...
module.exports = {
  ...
  async run({ conn, m, args }) {
    try {
      ...
      // 🕐 NIGERIA DATE & TIME
      // ===============================
      const dateNigeria = new Date().toLocaleDateString("en-GB", { timeZone: "Africa/Lagosl" });
      const timeNigeria = new Date().toLocaleTimeString("en-GB", { timeZone: "Africa/Lagos" });
...
🌸━━━━━━━━━━━━━━━━━━━🌸`;
      ...
      await conn.sendMessage(chatId, {
        image: { url: 'https://files.catbox.moe/i7o2wh.png' }, // Alive image
