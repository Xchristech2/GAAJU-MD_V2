const mindReads = [
  ...
  "*GAAJU-MD BOT* detected some deep thoughts 👁️✨",
  ...
  "*🧘 Energy level rising... GAAJU-MD reading deeper...*",
...
module.exports = {
  name: "mindread",
  description: "🧠 Reads the replied user's mind using GAAJU-MD's deep AI magic ✨",
  category: "fun",
